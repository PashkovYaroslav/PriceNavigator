...
public class PricePage extends AbstractPage {
    private final String SEARCH_FIELD = "//input[@id='edit-name-1']";
    private final String DESCRIPTION_OF_FIRST_PRODUCT = "//tr[contains(@class,'price_table_tr')][1]//a[@class='description-link']";
